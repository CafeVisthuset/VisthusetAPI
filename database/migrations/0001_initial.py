    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attached_to', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='BikeExtra', to='database.Bike', verbose_name='knuten till cykel')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bike_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Bike', verbose_name='Skada på cykel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booked_item', to='database.Booking')),
            ],
        ),
        migrations.CreateModel(
            name='Lunch',
            fields=[
                ...
                ('bookings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lunch', to='database.ItemsBooking')),
            ],
            options={
                'verbose_name': 'lunch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_date', models.DateField()),
                ('available', models.BooleanField(default=True)),
                ('room', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Rooms')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='utilities', to='database.ItemsBooking')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='bookings',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='availableBike', to='database.ItemsBooking'),
        ),
